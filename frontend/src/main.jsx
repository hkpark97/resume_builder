...
function App() {
  ...
  async function handleAuth(e) {
    ...
    if (authMode === "signup" && password !== authConfirmPassword.trim()) {
    ...
    try {
      ...
      if (saveAfterLogin && analysis) {
        ...
        await loadSaved();
        setNotice("Logged in and saved your result.");
      }
      ...
      {loading === "Analyzing resume..." && (
        <div className="loadingOverlay">
          <div className="loadingModal">
            ...
            <p>We’re comparing your resume against the job posting.</p>
          </div>
        </div>
      )}
